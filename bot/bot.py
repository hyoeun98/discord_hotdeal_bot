...
상품 정보를 보고 "대분류 → 중분류 → 소분류" 카테고리 태그 3개만 출력하라.
...
[예시]
제주 구좌 흙당근 5kg (6,620원/무료) → #식품 #채소 #당근
양파 5kg 100원딜 → #식품 #채소 #양파
RTX 4090 그래픽카드 24GB → #디지털 #PC부품 #그래픽카드
동원참치 라이트 살코기 150g 10캔 → #식품 #통조림 #참치캔
한돈 삼겹살 1kg 냉장 → #식품 #육류 #삼겹살
나이키 에어맥스 270 운동화 → #패션 #신발 #운동화
샤오미 미지아 헤어드라이기 H501 SE → #가전 #미용가전 #헤어드라이어
휴비딕 가정용 자동 칫솔살균기 → #생활용품 #욕실용품 #칫솔살균기
