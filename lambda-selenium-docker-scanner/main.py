...
class EOMI_SAE(PAGES):
    ...
    def get_item_links(self):
        ...
        'sameSite': 'Lax',
        'secure': False,
        'value': '%5B%5B%22AKsRol8QIsnFPgfEEq2aPtNq1x9Oavwe1l9Ei4D9p1tN7grDjjmcPx9vGXqwlRTDfXQxJ4xJzdA_Ee5wihrauo8sFrvZPoG3-T_wGfJ6SopbeliO_h5w44ujZfFp8xzYqXoPoUuZ7Izt5oZUmu9odEMoHjj76k_Krg%3D%3D%22%5D%5D'},
        ...
        'sameSite': 'None',
        'secure': True,
        'value': 'ID=fe6fe6a30986ce91:T=1750397241:RT=1750397241:S=AA-AfjZQ2mE1eRJtRwb6EaSETk76'},
        {'domain': 'eomisae.co.kr',
        'httpOnly': False,
        'name': 'PHPSESSID',
        'path': '/',
        'sameSite': 'Lax',
        'secure': False,
        'value': 'kujc0k1f2ufjuomm4mrvk1o20l'},
        {'domain': '.eomisae.co.kr',
        'expiry': 1784957240,
        'httpOnly': False,
        'name': '_ga',
        ...
        'sameSite': 'Lax',
        'secure': False,
        'value': 'GA1.1.325835503.1750397241'},
        {'domain': '.eomisae.co.kr',
        'expiry': 1784957240,
        'httpOnly': False,
        'name': '_fwb',
        ...
        'sameSite': 'Lax',
        'secure': False,
        'value': '91HwU6j8A7jOJXR0KFSOfV.1750397240374'},
        {'domain': '.eomisae.co.kr',
        'expiry': 1784957241,
        'httpOnly': False,
        'name': '_ga_BCJ0VWWVKZ',
        ...
        'sameSite': 'Lax',
        'secure': False,
        'value': 'GS2.1.s1750397240$o1$g0$t1750397241$j59$l0$h0'},
        {'domain': 'eomisae.co.kr',
        'httpOnly': False,
        'name': 'user-agent',
        'path': '/',
        'sameSite': 'Lax',
        'secure': False,
        'value': '0fe6feb54289f4c67027ec06cc2131f8'},
        {'domain': 'eomisae.co.kr',
        'httpOnly': False,
        'name': 'mobile',
        'path': '/',
        ...
        'sameSite': 'None',
        'secure': True,
        'value': 'UID=00001134d55071df:T=1750397241:RT=1750397241:S=ALNI_MYY8T_MN0eA_YQTXoK6vkQj6jUPwA'},
        {'domain': '.eomisae.co.kr',
        'expiry': 1784093241,
        'httpOnly': False,
        'name': '__gads',
        ...
        'sameSite': 'None',
        'secure': True,
        'value': 'ID=18329a824c8e5064:T=1750397241:RT=1750397241:S=ALNI_Mby0ELYY9O0SL3zkKWOU7MJ7tob2A'},
        {'domain': 'eomisae.co.kr',
        'expiry': 1750686663,
        'httpOnly': False,
        'name': 'ns_theme',
        ...
        'sameSite': 'Lax',
        'secure': False,
        'value': 'a06308f8077a60:1750397240'}]
            for cookie in cookies:
                self.get_item_driver.add_cookie(cookie)
            self.get_item_driver.get(self.site_name)
        except Exception as e:
            print(f"{self.site_name} 접속 실패 {str(e)}")
            return
